...
- hypothesis: Require a trustworthy verification path, bounded permissions, and a clear stop condition before increasing an autonomous task's duration or fan-out.
