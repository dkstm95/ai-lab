...
- Extend `packages/wiki` with bidirectional links, stronger retrieval, and reflection evals after
  the approved memory proposal flow has enough real usage data.
